...
const searchFacets = ["consortium", "accessType", "dataTypes", "diseases"]; // AnVIL facets (selected from workspace property values) for the dashboard checkboxes.
const summaryKey = "consortium";
const tableHeadersEntities = ["consortium", "projectId", "gapId", "studyName", "diseases", "accessType", "dataTypes", "samples", "size", "subjects"]; // add back access type
